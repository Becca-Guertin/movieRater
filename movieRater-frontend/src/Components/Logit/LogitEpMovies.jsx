...
import LogitEpMovieCard from "./LogitEpMovieCard";
import {
  Box,
  Heading,
  Text,
    ...
    const fetchMovies = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/all-logit-movies"
        );
    ...
    >
      ...
      >
        <SimpleGrid columns={2} spacing={4}>
          ...
          <Box>
            <Heading size="lg">Log-it! Episode Movies</Heading>
          </Box>
        </SimpleGrid>
      </Box>
